		...
		<h5 class="blue-text">Experiencia Profesional <i class="material-icons left ">work</i></h5>
      	...
      	<div class="row">
            ...
            <div class="col s12 grey-text text-darken-2 ">
              <div class="col s12">
                <p>
                  <input name="" type="checkbox" class="filled-in" id=""/>
                  <label for="">A la Fecha.</label>
                </p>
              </div>
              <div class="col s6">
                  <label class="label-select black-text" for="mo_fin_exp">Mes de Termino</label>
                  {!!Form::select('mo_fin_exp',trans('empleados.dates'), null, ['placeholder' => 'Mes', 'class' => 'browser-default'])!!}
              </div>
              <div class="col s6">
                  <label class="label-select black-text" for="y_ini_exp">Año de Termino</label>
                  ...
                  <div class="col s11 m11">
                     <ul class="experien">
                        ...
                        <li><strong>Periodo: </strong>
                         {{ trans('empleados.dates.'.$expe->mo_ini_exp) .' '.$expe->y_ini_exp}} 
                           @if($expe->to_date)
                             - {{ trans('empleados.dates.'.$expe->mo_fin_exp) .' '.$expe->y_fin_exp}}
                           @else
                           - A la Fecha
                           @endif
                        </li>
...
<!-- #### Termina Experiencia Profecional #### --><div class="row card-panel">
	<div class="row">
		<h5 class="blue-text">Experiencia Profesional <i class="material-icons left ">work</i></h5>
			<div class="col s12 m12 l8">
 				<h6 class="black-text text-darken-2">Experiencia Laboral</h6>
