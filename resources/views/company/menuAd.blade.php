    ...
    <ul id="nav-mobile" class="side-nav fixed">
        <li class="no-padding">
            <ul class="collapsible collapsible-accordion">
                ...
                <li class="bold"><a class="collapsible-header active  waves-effect waves-teal">Administracion <i class="material-icons right black-tes">keyboard_arrow_down</i></a>
                    <div class="collapsible-body">
                        <ul>
                            ...
                            <li><a href="{{ route('company.index') }}">Acceso Rapido</a></li>
                            <li><a href="{{ route('vacante.create') }}">Postular Vacante</a></li>
                            <li><a href="{{ route('vacante.admin') }}">Administrar Vacantes</a></li> <!--https://maps.pixelis.es/ -->
                            <li><a href="https://maps.pixelis.es" target="_blank">Mapa Pixelis</a></li>
                            <li><a href="{{ route('prospect.index') }}">Candidatos</a></li>
                   ...
                   <li class="bold"><a class="collapsible-header active  waves-effect waves-teal">Servicios <i class="material-icons right black-tes">keyboard_arrow_down</i></a>
                    <div class="collapsible-body">
                        <ul>
                            <li><a href="{{ route('company.services.create') }}" target="_blank">Crear</a></li>
                             <li><a href="{{ route('company.services.admin') }}" target="_blank">Administracion</a></li>
                              <li><a href="{{ route('company.services.list') }}" target="_blank">Buscar</a></li>
                        </ul>
                    </div>
                </li>
